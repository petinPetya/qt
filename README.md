...
- Загрузка: `QFileDialog` → `PIL.Image` → `QPixmap`
- Редактирование:
  - Кисть (цвет, толщина)
...
Как и заявлено в идее, функций пока немного, зато приложение предоставляет возможность накрчивать фичи благодаря устойчивой основе!
